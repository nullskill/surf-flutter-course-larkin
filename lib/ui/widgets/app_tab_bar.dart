...
/// [AppTabController] is a copy of standard widget except for the animateTo method.
/// It gets duration from constructor instead of hardcoded [kTabScrollDuration] constant.
/// Same for the [Curve].
...
class AppTabController extends TabController {
  ...
  void animateTo(
    ...
    super.animateTo(value, duration: this.duration, curve: this.curve);
  }
}

/// [AppTabBarView] is a copy of standard widget except for the animateToPage method.
/// It gets duration from [AppTabController] instead of hardcoded [kTabScrollDuration]
/// constant to be consistent with [TabBar] controller's duration. Same for the [Curve].
